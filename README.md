...
**Full-stack developer** based in Bogotá, Colombia. Currently finishing my Software Engineering degree (10th semester) and open to **junior developer roles**.

I build web and mobile apps using **Angular, React, PHP and SQL** — from UI to database. I enjoy clean code, collaborative work, and learning new tools fast.
...
📧 estebannsalazar@gmail.com · 📍 Bogotá, Colombia · 🔎 Open to junior dev roles
